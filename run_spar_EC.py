...
prob = Problem()
ivc = IndepVarComp()
ivc.add_output('D_spar_p', val=np.array([12.62691203, 8.76755563, 5., 5., 5., 15.57961884, 17.64435003, 14.99773247, 12.50650611, 10.38633563, 6.85979602]), units='m') #[12., 12., 12., 12., 12., 12., 12., 12., 12., 8.3, 8.3]
ivc.add_output('wt_spar_p', val=np.array([0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06, 0.06]), units='m')
ivc.add_output('L_spar', val=np.array([10.94374888, 10.68343488, 29.87301248, 28.26445856, 30., 5.85483623, 7.50485702, 7.0642234, 6.01204214, 10.]), units='m') #[13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 8., 14.]
...
ivc.add_output('z_moor', val=-10., units='m')
...
ivc.add_output('windspeed_0', val=9., units='m/s')
ivc.add_output('Hs', val=3.5, units='m')
ivc.add_output('Tp', val=12.5, units='s')
