...
class StateSpace(Group):
	...
	def setup(self):
		self.add_subsystem('A_struct', Astruct(), promotes_inputs=['M_global', 'A_global', 'B_global', 'K_global', 'CoG_rotor', 'I_d', 'dtorque_dv', 'dthrust_drotspeed', 'dtorque_drotspeed'], promotes_outputs=['A_struct'])
		...
		self.add_subsystem('B_feedbk', Bfeedbk(), promotes_inputs=['M_global', 'A_global', 'CoG_rotor', 'I_d', 'dthrust_dv', 'dmoment_dv', 'dtorque_dv', 'x_towermode', 'z_towermode', 'Z_tower'], promotes_outputs=['B_feedbk'])
