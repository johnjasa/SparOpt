...
class NormMoorTenMWind(ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		RAO_Mwind_moor_ten = K_moor * RAO_Mwind_fairlead

		outputs['Re_RAO_Mwind_moor_ten'] = np.real(RAO_Mwind_moor_ten)
	...
	def compute_partials(self, inputs, partials):
		...
		partials['Re_RAO_Mwind_moor_ten', 'Re_RAO_Mwind_fairlead'] = np.ones(N_omega) * K_moor
		partials['Re_RAO_Mwind_moor_ten', 'K_moor'] = np.real(RAO_Mwind_fairlead)

		partials['Im_RAO_Mwind_moor_ten', 'Im_RAO_Mwind_fairlead'] = np.ones(N_omega) * K_moor
		partials['Im_RAO_Mwind_moor_ten', 'K_moor'] = np.imag(RAO_Mwind_fairlead)