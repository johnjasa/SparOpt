...
class Condition(Group):
	...
	def setup(self):
		...
		self.add_subsystem('postpro', postpro_group, promotes_inputs=['Re_wave_force_surge', 'Im_wave_force_surge', 'Re_wave_force_pitch', 'Im_wave_force_pitch', \
			...
			'stddev_bldpitch', 'stddev_tower_stress', 'stddev_hull_moment', 'mean_surge', 'mean_pitch', 'mean_tower_stress', 'mean_hull_moment', 'v_z_surge', 'v_z_pitch', \
			'v_z_tower_stress', 'v_z_hull_moment', 'tower_fatigue_damage', 'hull_fatigue_damage'])
