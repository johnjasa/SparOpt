...
class HullMisesStress(ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		outputs['sigma_j'] = np.sqrt((inputs['sigma_a'] + inputs['sigma_m'])**2. - (inputs['sigma_a'] + inputs['sigma_m']) * inputs['sigma_h'] + inputs['sigma_h']**2.)
	...
	def compute_partials(self, inputs, partials):
		...
		partials['sigma_j', 'sigma_a'] = 0.5 / np.sqrt((inputs['sigma_a'] + inputs['sigma_m'])**2. - (inputs['sigma_a'] + inputs['sigma_m']) * inputs['sigma_h'] + inputs['sigma_h']**2.) * (2. * (inputs['sigma_a'] + inputs['sigma_m']) - inputs['sigma_h'])
		partials['sigma_j', 'sigma_m'] = 0.5 / np.sqrt((inputs['sigma_a'] + inputs['sigma_m'])**2. - (inputs['sigma_a'] + inputs['sigma_m']) * inputs['sigma_h'] + inputs['sigma_h']**2.) * (2. * (inputs['sigma_a'] + inputs['sigma_m']) - inputs['sigma_h'])
		partials['sigma_j', 'sigma_h'] = 0.5 / np.sqrt((inputs['sigma_a'] + inputs['sigma_m'])**2. - (inputs['sigma_a'] + inputs['sigma_m']) * inputs['sigma_h'] + inputs['sigma_h']**2.) * (-inputs['sigma_a'] - inputs['sigma_m'] + 2. * inputs['sigma_h'])
