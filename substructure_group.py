...
class Substructure(Group):
	 ...
	 def setup(self):
		...
		self.add_subsystem('bending_addedmass', BendingAddedMass(), promotes_inputs=['x_sparmode', 'z_sparmode', 'Z_spar', 'spar_draft'], promotes_outputs=['A17', 'A57', 'A77'])
		
		self.add_subsystem('bending_damping', BendingDamping(), promotes_inputs=['D_tower', 'wt_tower', 'Z_tower', 'x_towermode', 'z_towermode'], promotes_outputs=['B_struct_77'])
		
		self.add_subsystem('bending_stiffness', BendingStiffness(), promotes_inputs=['z_sparmode', 'x_sparmode', 'z_towermode', 'x_towermode', 'D_tower', 'wt_tower', 'M_tower', 'L_tower', 'Z_tower', 'K_moor', 'M_moor', 'z_moor', 'buoy_spar', 'CoB', 'M_secs', 'CoG_spar', 'M_ball', 'CoG_ball'], promotes_outputs=['K17', 'K57', 'K77'])
	 	...
	 	self.add_subsystem('global_addedmass', GlobalAddedMass(), promotes_inputs=['A11', 'A15', 'A55'], promotes_outputs=['A_global'])
