...
class GlobalDamping(ExplicitComponent):
	...
	def setup(self):
		self.add_input('B_aero_11', val=0., units='N*s/m')
		...
		self.add_input('B_visc_11', val=0., units='N*s/m')
	...
	def compute(self, inputs, outputs):
		...
		outputs['B_global'][0,0] += inputs['B_aero_11'] + inputs['B_visc_11']
		outputs['B_global'][0,1] += inputs['B_aero_15'] + inputs['B_visc_15']
		outputs['B_global'][0,2] += inputs['B_aero_17'] + inputs['B_visc_17']
		outputs['B_global'][1,0] += inputs['B_aero_15'] + inputs['B_visc_15']
		outputs['B_global'][1,1] += inputs['B_aero_55'] + inputs['B_visc_55']
		outputs['B_global'][1,2] += inputs['B_aero_57'] + inputs['B_visc_57']
		outputs['B_global'][2,0] += inputs['B_aero_17'] + inputs['B_visc_17']
		outputs['B_global'][2,1] += inputs['B_aero_57'] + inputs['B_visc_57']
		outputs['B_global'][2,2] += inputs['B_aero_77'] + inputs['B_visc_77'] + inputs['B_struct_77']
	...
	def compute_partials(self, inputs, partials):
		...
		partials['B_global', 'B_visc_11'] = np.array([1., 0., 0., 0., 0., 0., 0., 0., 0.])
		partials['B_global', 'B_visc_15'] = np.array([0., 1., 0., 1., 0., 0., 0., 0., 0.])
		partials['B_global', 'B_visc_17'] = np.array([0., 0., 1., 0., 0., 0., 1., 0., 0.])
		partials['B_global', 'B_visc_55'] = np.array([0., 0., 0., 0., 1., 0., 0., 0., 0.])
		partials['B_global', 'B_visc_57'] = np.array([0., 0., 0., 0., 0., 1., 0., 1., 0.])
		partials['B_global', 'B_visc_77'] = np.array([0., 0., 0., 0., 0., 0., 0., 0., 1.])
