...
class ConstrMomInertiaRingstiff(ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		outputs['constr_mom_inertia_ringstiff'] = inputs['I_R'] / inputs['I_stiff'] - 1. #less than 0 to satisfy constraint

	def compute_partials(self, inputs, partials):
		partials['constr_mom_inertia_ringstiff', 'I_R'] = 1. / inputs['I_stiff']
		partials['constr_mom_inertia_ringstiff', 'I_stiff'] = -inputs['I_R'] / inputs['I_stiff']**2.
