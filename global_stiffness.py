...
class GlobalStiffness(ExplicitComponent):
	...
	def compute_partials(self, inputs, partials):
		...
		partials['K_global', 'CoG_total'] = np.array([0., K_moor, 0., K_moor, 2. * K_moor * CoG_total - M_moor * 9.80665 - (tot_M_spar + M_ball + M_turb) * 9.80665, 0., 0., 0., 0.])
		...
		partials['K_global', 'K77'] = np.array([0., 0., 0., 0., 0., 0., 0., 0., 1.])
		partials['K_global', 'buoy_spar'] = np.array([0., 0., 0., 0., CoB, 0., 0., 0., 0.])
		partials['K_global', 'CoB'] = np.array([0., 0., 0., 0., buoy_spar, 0., 0., 0., 0.])