...
class NormTBMomentMWind(ExplicitComponent):
	...
	def setup(self):
		...
		self.add_input('Re_RAO_Mwind_vel_surge', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Re_RAO_Mwind_vel_pitch', val=np.zeros(N_omega), units='rad/(m/s)')
		self.add_input('Re_RAO_Mwind_vel_bend', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Im_RAO_Mwind_vel_surge', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Im_RAO_Mwind_vel_pitch', val=np.zeros(N_omega), units='rad/(m/s)')
		self.add_input('Im_RAO_Mwind_vel_bend', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Re_RAO_Mwind_acc_surge', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Re_RAO_Mwind_acc_pitch', val=np.zeros(N_omega), units='rad/(m/s)')
		self.add_input('Re_RAO_Mwind_acc_bend', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Im_RAO_Mwind_acc_surge', val=np.zeros(N_omega), units='m/(m/s)')
		self.add_input('Im_RAO_Mwind_acc_pitch', val=np.zeros(N_omega), units='rad/(m/s)')
		self.add_input('Im_RAO_Mwind_acc_bend', val=np.zeros(N_omega), units='m/(m/s)')
