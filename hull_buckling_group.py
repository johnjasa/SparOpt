...
from shell_buckling import ShellBuckling
...
from constr_hoop_stress import ConstrHoopStress
...
class HullBuckling(Group):
	...
	def setup(self):
		...
		self.add_subsystem('shell_buckling', ShellBuckling(), promotes_inputs=['sigma_j', 'f_ksd'], promotes_outputs=['shell_buckling'])
		...
		self.add_subsystem('constr_hoop_stress', ConstrHoopStress(), promotes_inputs=['sigma_hR', 'f_r'], promotes_outputs=['constr_hoop_stress'])
