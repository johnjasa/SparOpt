...
class GlobalMass(ExplicitComponent):
	...
	def compute_partials(self, inputs, partials):
		...
		partials['M_global', 'tot_M_spar'] = np.array([1., CoG_spar, 0., CoG_spar, 0., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'M_ball'] = np.array([1., CoG_ball, 0., CoG_ball, 0., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'M_turb'] = np.array([1., CoG_turb, 0., CoG_turb, 0., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'CoG_spar'] = np.array([0., tot_M_spar, 0., tot_M_spar, 0., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'CoG_ball'] = np.array([0., M_ball, 0., M_ball, 0., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'CoG_turb'] = np.array([0., M_turb, 0., M_turb, 0., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'I_spar'] = np.array([0., 0., 0., 0., 1., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'I_ball'] = np.array([0., 0., 0., 0., 1., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'I_turb'] = np.array([0., 0., 0., 0., 1., 0., 0., 0., 0.], dtype='float')
		partials['M_global', 'M17'] = np.array([0., 0., 1., 0., 0., 0., 1., 0., 0.], dtype='float')
		partials['M_global', 'M57'] = np.array([0., 0., 0., 0., 0., 1., 0., 1., 0.], dtype='float')
		partials['M_global', 'M77'] = np.array([0., 0., 0., 0., 0., 0., 0., 0., 1.], dtype='float')
