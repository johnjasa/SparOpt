...
class Aero(Group):
	...
	def setup(self):
		...
		self.add_subsystem('wind_speed', WindSpeed(blades=blades), promotes_inputs=['windspeed_0', 'rotspeed_0', 'omega', 'b_elem_r', 'b_elem_dr', 'dFn_dv', 'dFt_dv', 'omega'], promotes_outputs=['thrust_wind', 'moment_wind', 'torque_wind'])
